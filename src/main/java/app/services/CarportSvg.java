...
public class CarportSvg {
   ...
   public CarportSvg(int width, int length, int height, int shedLength, int shedWidth, String roof) {
    ...
    public CarportSvg(int width, int length, int height, int shedLength, int shedWidth) {
        ...
        addPoles(width, length, height, shedLength, shedWidth);

        addBeams(width, length);
        addRafters(width, length);
        addLineWithStroke(width, length);
        addArrowsForTheTopPainting(width, length);
        addTextV((length / 2) + 30, width + 55+75, 0, "" + length + " cm");
        addTextH(40, (width / 2) - 20+75, 0, "" + width + " cm");
        addTextH(10, (width / 2) - 20+75, 0, "" + (width-60) + " cm");
    }
   ...
   private void addBeams(int width, int length) {
    ...
    private void addLineWithStroke(int width, int length) {
        if(shedLength == 0) {
    ...
    public void addPoles(int width, int length, int height, int shedLength, int shedWidth) {
        double x = 0;
        double y = 0;
