...
public class Svg {
    ...
    private static final String SVG_LINE_TEMPLATE = "<line x1=\"%.1f\" y1=\"%.1f\" x2=\"%.1f\" y2=\"%.1f\" style=\"%s; stroke-dasharray: 4 4;\" />\n";
    private static final String SVG_ARROW_TEMPLATE = "<line x1=\"%d\" y1=\"%d\" x2=\"%d\" y2=\"%d\" style=\"stroke:#000000;\n" +
            "marker-start: url(#beginArrow);\n" + "marker-end: url(#endArrow);\"/>\n";
    public static final String VERTICAL_TEXT_TEMPLATE = "<text x=\"%d\" y=\"%d\" transform=\"rotate(%d)\">%s</text>\n";
    public static final String HORIZONTAL_TEXT_TEMPLATE = "<text x=\"%d\" y=\"%d\" transform=\"rotate(%d)\" style=\"writing-mode: tb;\">%s</text>\n";
    ...
    public void addTextH(int x, int y, int rotation, String text, String style) {
        svg.append(String.format(HORIZONTAL_TEXT_TEMPLATE, x, y, rotation, text, style));
    }

    public void addTextV(int x, int y, int rotation, String text, String style) {
